...
function loadingView(){return `<div class="authScreen"><div class="authBox"><img class="authLogo" src="${logoIcon()}" alt="TOTIME"><h1>Caricamento...</h1><p class="sub">Connessione al database Supabase.</p></div></div>`}
function loginView(){return `<div class="authScreen"><div class="authBox"><img class="authLogo" src="${logoIcon()}" alt="TOTIME"><h1>Accedi al tuo profilo</h1>${state.message?`<p class="small">${esc(state.message)}</p>`:''}<div class="card authCard"><form class="form" onsubmit="signIn(event)"><div class="field"><label>Email</label><input name="email" type="email" placeholder="Inserisci il tuo indirizzo email" autocomplete="email" required></div><div class="field"><label>Password</label><input name="password" type="password" placeholder="Inserisci la tua password" autocomplete="current-password" required></div><button class="primary">Accedi</button></form></div><p class="sub authSwitch">Non hai un account? <a href="#" onclick="event.preventDefault();state.view='register';state.message='';render()">Registrati</a></p></div></div>`}
function registerView(){return `<div class="authScreen"><div class="authBox"><img class="authLogo" src="${logoIcon()}" alt="TOTIME"><h1>Crea account TOTIME</h1><p class="sub">Inserisci i dati del tuo profilo per collegare configurazioni, consuntivi e fatturazione al tuo account.</p>${state.message?`<p class="small">${esc(state.message)}</p>`:''}<div class="card authCard"><form class="form" onsubmit="signUpDetailed(event)"><div class="field"><label>Nome</label><input name="first_name" autocomplete="given-name" required></div><div class="field"><label>Cognome</label><input name="last_name" autocomplete="family-name" required></div><div class="field"><label>Azienda / Ragione sociale</label><input name="company_name" autocomplete="organization" required></div><div class="field"><label>P.IVA</label><input name="vat_number" inputmode="numeric" autocomplete="off" required></div><div class="field"><label>Email</label><input name="email" type="email" placeholder="Inserisci il tuo indirizzo email" autocomplete="email" required></div><div class="field"><label>Password</label><input name="password" type="password" placeholder="Inserisci la tua password" autocomplete="new-password" minlength="6" required></div><button class="primary">Crea account</button></form></div><p class="sub authSwitch">Hai gia' un account? <a href="#" onclick="event.preventDefault();state.view='login';state.message='';render()">Torna al login</a></p></div></div>`}
